...
SECRET_KEY = 'django-insecure-^abm&y8kl9g2zkk8g^y7-!!)oc)cza0hk#n1r8h33-k5g9)+yd'
...
WSGI_APPLICATION = 'CustomsManagerOnline.wsgi.application'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/1",  # ← port 6379 çünkü Redis burada çalışıyor
        "OPTIONS": {
